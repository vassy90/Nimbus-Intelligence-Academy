...
SELECT email from public.email_table
INNER JOIN public.data_table on public.email_table.join_id = public.data_table.join_id
WHERE column_1 % 2 = 0
AND column_2 < column_1
AND column_3 % 10 = 1;

/* The resulting email address is:
 1867945546@theinformationlab.nl  */